...
First, install Python (follow instructions on https://www.python.org/downloads/).

Then, inside a terminal:  
1. Clone the code from GitHub: `git clone https://github.com/davidmurray/cycling-network-design.git`  
2. Change to the cloned directory: `cd cycling-network-design`  
3. Create a virtual environment: `python -m venv .`  
4. Activate the virtual environment: `source bin/activate` (note: command may differ on Windows)  
